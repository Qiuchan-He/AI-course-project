...
#include "neuralfd/neural_networks/torch_policy_network.h"
...
TorchPolicyNetwork::TorchPolicyNetwork(const Options& opts)
    : TorchNetwork(opts)
...
TorchPolicyNetwork::get_input_tensors(const State& state)
{
...
static Plugin<neural_networks::AbstractNetwork>
    _plugin("torch_policy_network", _parse);
