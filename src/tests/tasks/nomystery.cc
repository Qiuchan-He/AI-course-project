...
NoMysteryProblem::NoMysteryProblem(
    int locations,
    int packages,
    int truck_capacity,
...
int NoMysteryProblem::get_variable_truck_at() const
{
    return 0;
}

int NoMysteryProblem::get_variable_packages_loaded() const
{
    return 1;
}

int NoMysteryProblem::get_variable_package_at(int package) const
{
    return 2 + package;
}

FactPair NoMysteryProblem::get_fact_truck_at_location(int location) const
{
    return {get_variable_truck_at(), location};
}

FactPair NoMysteryProblem::get_fact_packages_loaded(int num_loaded) const
{
    return {get_variable_packages_loaded(), num_loaded};
}

FactPair
NoMysteryProblem::get_fact_package_at_location(int package, int location) const
{
    return {get_variable_package_at(package), location};
}

FactPair NoMysteryProblem::get_fact_package_in_truck(int package) const
{
    return {get_variable_package_at(package), locations};
}

OperatorID NoMysteryProblem::get_operator_load_package_id(
    int location,
    int package,
...
OperatorID NoMysteryProblem::get_operator_unload_package_id(
    int location,
    int package,
    int num_already_loaded) const
{
...
OperatorID
NoMysteryProblem::get_operator_drive_id(int origin, int destination) const
{
    return OperatorID(get_operator_drive_index(origin, destination));
}

int NoMysteryProblem::get_operator_load_package_index(
    int location,
    int package,
    int num_already_loaded) const
{
...
int NoMysteryProblem::get_operator_unload_package_index(
    int location,
    int package,
    int num_already_loaded) const
{
...
int NoMysteryProblem::get_operator_drive_index(int origin, int destination)
    const
{
