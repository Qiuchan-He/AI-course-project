...
TEST(ReplayBufferExperienceSamplerTestsPublic, test_bw_one_simulation)
{
    // Test parameters
    static constexpr int SIMULATOR_SEED = 3495;
    static constexpr int POLICY_SEED = 4067;
    static constexpr int REPLAY_SEED = 777;
    ...
    ReplayBufferExperienceSampler sampler(
        simulator,
        policy,
        SIMULATIONS,
        EXPLORATIONS,
        BUFFER_SIZE,
        std::make_shared<utils::RandomNumberGenerator>(REPLAY_SEED));

    // The expected experience samples are read from the specified file.
    auto samples = read_experience_samples_from_file(
        *wrapped,
        "bw_one_simulation_replay_buffer.samples");
...
TEST(ReplayBufferExperienceSamplerTestsPublic, test_bw_multiple_simulations)
{
    // Test parameters
    ...
    auto samples = read_experience_samples_from_file(
        *wrapped,
        "bw_multiple_simulations_replay_buffer.samples");
...
TEST(ReplayBufferExperienceSamplerTestsPublic, test_sokoban_one_simulation)
{
    // Test parameters
    static constexpr int SIMULATOR_SEED = 3495;
    static constexpr int POLICY_SEED = 4067;
    ...
    auto samples = read_experience_samples_from_file(
        *wrapped,
        "sokoban_one_simulation_replay_buffer.samples");
...
TEST(
    ReplayBufferExperienceSamplerTestsPublic,
    test_sokoban_multiple_simulations)
{
    // Test parameters
    static constexpr int SIMULATOR_SEED = 42;
    static constexpr int POLICY_SEED = 1337;
    ...
    auto samples = read_experience_samples_from_file(
        *wrapped,
        "sokoban_multiple_simulations_replay_buffer.samples");
...
TEST(ReplayBufferExperienceSamplerTestsPublic, test_visitall_one_simulation)
{
    // Test parameters
    static constexpr int SIMULATOR_SEED = 3495;
    static constexpr int POLICY_SEED = 4067;
    ...
    auto samples = read_experience_samples_from_file(
        *wrapped,
        "visitall_one_simulation_replay_buffer.samples");
...
TEST(
    ReplayBufferExperienceSamplerTestsPublic,
    test_visitall_multiple_simulations)
{
    // Test parameters
    static constexpr int SIMULATOR_SEED = 42;
    static constexpr int POLICY_SEED = 1337;
    ...
    auto samples = read_experience_samples_from_file(
        *wrapped,
        "visitall_multiple_simulations_replay_buffer.samples");
...
TEST(ReplayBufferExperienceSamplerTestsPublic, test_gripper_one_simulation)
{
    // Test parameters
    static constexpr int SIMULATOR_SEED = 3495;
    static constexpr int POLICY_SEED = 4067;
    ...
    auto samples = read_experience_samples_from_file(
        *wrapped,
        "gripper_one_simulation_replay_buffer.samples");
...
TEST(
    ReplayBufferExperienceSamplerTestsPublic,
    test_gripper_multiple_simulations)
{
    // Test parameters
    static constexpr int SIMULATOR_SEED = 42;
    static constexpr int POLICY_SEED = 1337;
    ...
    auto samples = read_experience_samples_from_file(
        *wrapped,
        "gripper_multiple_simulations_replay_buffer.samples");
...
TEST(ReplayBufferExperienceSamplerTestsPublic, test_nomystery_one_simulation)
{
    // Test parameters
    static constexpr int SIMULATOR_SEED = 3495;
    static constexpr int POLICY_SEED = 4067;
    ...
    auto samples = read_experience_samples_from_file(
        *wrapped,
        "nomystery_one_simulation_replay_buffer.samples");
...
TEST(
    ReplayBufferExperienceSamplerTestsPublic,
    test_nomystery_multiple_simulations)
{
    // Test parameters
    static constexpr int SIMULATOR_SEED = 42;
    static constexpr int POLICY_SEED = 1337;
    ...
    auto samples = read_experience_samples_from_file(
        *wrapped,
        "nomystery_multiple_simulations_replay_buffer.samples");
