...
TEST(GoalCountHeuristicTestsPublic, test_bw_goal_aware)
{
    // 4 blocks
    ...
    auto goal_count_heuristic = std::make_shared<GoalCountHeuristic>(task);

    ASSERT_EQ(get_initial_state_estimate(*task, *goal_count_heuristic), 0);
}

TEST(GoalCountHeuristicTestsPublic, test_bw_single_state)
{
    // 4 blocks
    BlocksWorldProblem problem(4);
...
TEST(GoalCountHeuristicTestsPublic, test_bw_single_state_reeval)
{
    // 4 blocks
    BlocksWorldProblem problem(4);
...
TEST(GoalCountHeuristicTestsPublic, test_bw_astar)
{
    // 4 blocks
    ...
    auto task = create_problem_task(problem, initial_state, goal);
    auto goal_count_heuristic = std::make_shared<GoalCountHeuristic>(task);
    auto algorithm = create_astar_search_algorithm(task, goal_count_heuristic);

    algorithm->search();

    ASSERT_TRUE(algorithm->found_solution());
    ASSERT_EQ(algorithm->get_statistics().get_expanded(), 2783);
...
TEST(GoalCountHeuristicTestsPublic, test_gripper_goal_aware)
{
    // 2 rooms, 2 balls
...
TEST(GoalCountHeuristicTestsPublic, test_gripper_single_state)
{
    // 2 rooms, 2 balls
    GripperProblem problem(2, 2);
...
TEST(GoalCountHeuristicTestsPublic, test_gripper_single_state_reeval)
{
    // 2 rooms, 2 balls
    GripperProblem problem(2, 2);
...
TEST(GoalCountHeuristicTestsPublic, test_gripper_astar)
{
    // 2 rooms, 2 balls
    GripperProblem problem(2, 2);
...
TEST(GoalCountHeuristicTestsPublic, test_visitall_goal_aware)
{
    // 2 rooms, 2 balls
...
TEST(GoalCountHeuristicTestsPublic, test_visitall_single_state)
{
    // 2 rooms, 2 balls
    VisitAllProblem problem(2, 2);
...
TEST(GoalCountHeuristicTestsPublic, test_visitall_single_state_reeval)
{
    // 2 rooms, 2 balls
    VisitAllProblem problem(2, 2);
...
TEST(GoalCountHeuristicTestsPublic, test_visitall_astar)
{
    // 2 rooms, 2 balls
    VisitAllProblem problem(2, 2);
...
TEST(GoalCountHeuristicTestsPublic, test_sokoban_goal_aware)
{
...
TEST(GoalCountHeuristicTestsPublic, test_sokoban_single_state)
{
    const SokobanGrid playarea = {
        {' ', ' ', ' '},
        {' ', 'G', ' '},
...
TEST(GoalCountHeuristicTestsPublic, test_sokoban_single_state_reeval)
{
    const SokobanGrid playarea = {
        {' ', ' ', ' '},
        {' ', 'G', ' '},
...
TEST(GoalCountHeuristicTestsPublic, test_sokoban_astar)
{
    const SokobanGrid playarea = {
        {' ', ' ', ' '},
        {' ', ' ', 'G'},
    ...
    ASSERT_TRUE(algorithm->found_solution());
    ASSERT_EQ(algorithm->get_statistics().get_expanded(), 11);
...
TEST(GoalCountHeuristicTestsPublic, test_nomystery_goal_aware)
{
    // 0 -- 1 -- 2 -- 3
...
TEST(GoalCountHeuristicTestsPublic, test_nomystery_single_state)
{
    // 4 -- 5 -- 6
    // |  /
    // | /
...
TEST(GoalCountHeuristicTestsPublic, test_nomystery_single_state_reeval)
{
    // 4 -- 5 -- 6
    // |  /
    // | /
...
TEST(GoalCountHeuristicTestsPublic, test_nomystery_astar)
{
    // 4 -- 5 -- 6
    // |  /    /
    // | /    /
    ...
    ASSERT_TRUE(algorithm->found_solution());
    ASSERT_EQ(algorithm->get_statistics().get_expanded(), 256);
