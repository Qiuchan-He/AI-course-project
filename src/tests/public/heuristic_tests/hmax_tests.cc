...
TEST(HMaxHeuristicTestsPublic, test_bw_goal_aware)
{
    // 4 blocks
    ...
    auto hmax = std::make_shared<HSPMaxHeuristic>(task);

    ASSERT_EQ(get_initial_state_estimate(*task, *hmax), 0);
}

TEST(HMaxHeuristicTestsPublic, test_bw_single_state)
{
    // 4 blocks
    BlocksWorldProblem problem(4);
    ...
    ASSERT_EQ(get_initial_state_estimate(*task, *hmax), 2);
}

TEST(HMaxHeuristicTestsPublic, test_bw_single_state_reeval)
{
    // 4 blocks
    BlocksWorldProblem problem(4);
...
TEST(HMaxHeuristicTestsPublic, test_bw_astar)
{
    // 4 blocks
    ...
    auto task = create_problem_task(problem, initial_state, goal);
    auto hmax = std::make_shared<HSPMaxHeuristic>(task);
    auto algorithm = create_astar_search_algorithm(task, hmax);

    algorithm->search();

    ASSERT_TRUE(algorithm->found_solution());
    ASSERT_EQ(algorithm->get_statistics().get_reopened(), 0);
    ASSERT_EQ(algorithm->get_statistics().get_expanded(), 3007);
...
TEST(HMaxHeuristicTestsPublic, test_gripper_goal_aware)
{
    // 2 rooms, 2 balls
...
TEST(HMaxHeuristicTestsPublic, test_gripper_single_state)
{
    // 2 rooms, 2 balls
    GripperProblem problem(2, 2);
...
TEST(HMaxHeuristicTestsPublic, test_gripper_single_state_reeval)
{
    // 2 rooms, 2 balls
    GripperProblem problem(2, 2);
...
TEST(HMaxHeuristicTestsPublic, test_gripper_astar)
{
    // 2 rooms, 2 balls
    GripperProblem problem(2, 2);
    ...
    ASSERT_TRUE(algorithm->found_solution());
    ASSERT_EQ(algorithm->get_statistics().get_reopened(), 0);
    ASSERT_EQ(algorithm->get_statistics().get_expanded(), 12);
...
TEST(HMaxHeuristicTestsPublic, test_visitall_goal_aware)
{
    // 2 rooms, 2 balls
...
TEST(HMaxHeuristicTestsPublic, test_visitall_single_state)
{
    // 2 rooms, 2 balls
    VisitAllProblem problem(2, 2);
...
TEST(HMaxHeuristicTestsPublic, test_visitall_single_state_reeval)
{
    // 2 rooms, 2 balls
    VisitAllProblem problem(2, 2);
...
TEST(HMaxHeuristicTestsPublic, test_visitall_astar)
{
    // 2 rooms, 2 balls
    VisitAllProblem problem(2, 2);
    ...
    ASSERT_TRUE(algorithm->found_solution());
    ASSERT_EQ(algorithm->get_statistics().get_reopened(), 0);
    ASSERT_EQ(algorithm->get_statistics().get_expanded(), 4);
...
TEST(HMaxHeuristicTestsPublic, test_sokoban_goal_aware)
{
...
TEST(HMaxHeuristicTestsPublic, test_sokoban_dead_end)
{
    const SokobanGrid playarea = {
        {' ', ' ', ' '},
        {' ', ' ', ' '},
    ...
    ASSERT_EQ(get_initial_state_estimate(*task, *hmax), Heuristic::DEAD_END);
}

TEST(HMaxHeuristicTestsPublic, test_sokoban_single_state)
{
    const SokobanGrid playarea = {
        {' ', 'G', 'G'},
        {' ', ' ', ' '},
...
TEST(HMaxHeuristicTestsPublic, test_sokoban_single_state_reeval)
{
    const SokobanGrid playarea = {
        {' ', 'G', 'G'},
        {' ', ' ', ' '},
...
TEST(HMaxHeuristicTestsPublic, test_sokoban_astar)
{
    const SokobanGrid playarea = {
        {' ', ' ', ' '},
        {' ', ' ', 'G'},
...
TEST(HMaxHeuristicTestsPublic, test_nomystery_goal_aware)
{
    // 0 -- 1 -- 2 -- 3
...
TEST(HMaxHeuristicTestsPublic, test_nomystery_dead_end)
{
...
TEST(HMaxHeuristicTestsPublic, test_nomystery_single_state)
{
    // 4 -- 5 -- 6
    // |  /
    // | /
    ...
    ASSERT_EQ(get_initial_state_estimate(*task, *hmax), 3);
}

TEST(HMaxHeuristicTestsPublic, test_nomystery_single_state_reeval)
{
    // 4 -- 5 -- 6
    // |  /
    // | /
...
TEST(HMaxHeuristicTestsPublic, test_nomystery_astar)
{
    // 4 -- 5 -- 6
    // |  /    /
    // | /    /
    ...
    ASSERT_TRUE(algorithm->found_solution());
    ASSERT_EQ(algorithm->get_statistics().get_reopened(), 0);
    ASSERT_EQ(algorithm->get_statistics().get_expanded(), 156);
