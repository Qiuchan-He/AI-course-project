...
/**
 * @brief A BlocksWorld problem consists of \f$N\f$ blocks arranged in stacks.
 ...
 * the hand.
 * + \f$\textsf{Clear} \in \{ \text{true}, \text{false} \}(b)\f$ - Whether there
...
public:
    ...
    /// Get the fact \f$Clear(b) = B\f$, where
