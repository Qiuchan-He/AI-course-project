#ifndef NEURALFD_NEURAL_NETWORKS_TORCH_POLICY_NETWORK_H
#define NEURALFD_NEURAL_NETWORKS_TORCH_POLICY_NETWORK_H

#include "neuralfd/neural_networks/torch_network.h"
...
class TorchPolicyNetwork : public TorchNetwork {
    ...
    get_input_tensors(const State& state) override;
