#ifndef NEURALFD_HEURISTICS_NETWORK_HEURISTIC_H
#define NEURALFD_HEURISTICS_NETWORK_HEURISTIC_H
...
protected:
    ...
    std::pair<int, double>
    compute_heuristic_and_confidence(const State& state) override;
