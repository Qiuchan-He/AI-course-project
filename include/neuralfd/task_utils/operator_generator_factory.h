#ifndef NEURALFD_TASK_UTILS_OPERATOR_GENERATOR_FACTORY_H
#define NEURALFD_TASK_UTILS_OPERATOR_GENERATOR_FACTORY_H
...
protected:
    ...
    template <typename AnyOperatorsProxy>
    GeneratorPtr internal_create(AnyOperatorsProxy operators)
    {
...
#endif // NEURALFD_TASK_UTILS_OPERATOR_GENERATOR_FACTORY_H
