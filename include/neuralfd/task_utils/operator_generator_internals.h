#ifndef NEURALFD_TASK_UTILS_OPERATOR_GENERATOR_INTERNALS_H
#define NEURALFD_TASK_UTILS_OPERATOR_GENERATOR_INTERNALS_H
...
public:
    ...
    virtual OperatorID generate_min_applicable_op(
