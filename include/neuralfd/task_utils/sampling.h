#ifndef NEURALFD_TASK_UTILS_SAMPLING_H
#define NEURALFD_TASK_UTILS_SAMPLING_H
...
class RandomRegressionWalkSampler {
    ...
    const std::unique_ptr<predecessor_generator::PredecessorGenerator>
...
#endif // NEURALFD_TASK_UTILS_SAMPLING_H
