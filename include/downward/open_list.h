#ifndef DOWNWARD_OPEN_LIST_H
#define DOWNWARD_OPEN_LIST_H
...
protected:
    ...
    */
    virtual void
    do_insertion(EvaluationContext& eval_context, const Entry& entry) = 0;
...
public:
    ...
    */
    ...
    virtual bool
    is_reliable_dead_end(EvaluationContext& eval_context) const = 0;
};
