#ifndef DOWNWARD_OPTIONS_DOC_UTILS_H
#define DOWNWARD_OPTIONS_DOC_UTILS_H

#include "downward/options/bounds.h"
...
using PluginTypeNameGetter =
    std::function<std::string(const Registry& registry)>;
using PredefinitionFunction = std::function<
    void(const std::string&, Registry&, Predefinitions&, bool, bool)>;
...
/*
  ...
  type of plugins (e.g. "SearchAlgorithm" or "MergeStrategyFactory").
*/
struct PluginTypeInfo {
    ...
    */
    ...
    // Alternative command line arguments to predefine Plugins of this
    // PluginType.
    std::string alias;
