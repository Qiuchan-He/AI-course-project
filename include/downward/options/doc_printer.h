#ifndef DOWNWARD_OPTIONS_DOC_PRINTER_H
#define DOWNWARD_OPTIONS_DOC_PRINTER_H
...
protected:
    ...
    virtual void
    print_usage(const std::string& name, const PluginInfo& info) = 0;
...
protected:
    ...
    virtual void
    print_usage(const std::string& name, const PluginInfo& info) override;
    ...
    virtual void
    print_category_header(const std::string& category_name) override;
