#ifndef DOWNWARD_TASK_UTILS_SUCCESSOR_GENERATOR_H
#define DOWNWARD_TASK_UTILS_SUCCESSOR_GENERATOR_H
...
public:
    explicit SuccessorGenerator(const PlanningTaskProxy& task_proxy);
    /*
