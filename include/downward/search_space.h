#ifndef DOWNWARD_SEARCH_SPACE_H
#define DOWNWARD_SEARCH_SPACE_H
...
public:
    ...
    void dump(const ClassicalTaskProxy& task_proxy, utils::LogProxy& log) const;
};
...
public:
    ...
    void dump(const ClassicalTaskProxy& task_proxy) const;
