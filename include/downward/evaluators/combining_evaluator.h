#ifndef DOWNWARD_EVALUATORS_COMBINING_EVALUATOR_H
#define DOWNWARD_EVALUATORS_COMBINING_EVALUATOR_H
...
extern void
add_combining_evaluator_options_to_parser(options::OptionParser& parser);
} // namespace combining_evaluator
