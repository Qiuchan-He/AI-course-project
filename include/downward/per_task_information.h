#ifndef DOWNWARD_PER_TASK_INFORMATION_H
#define DOWNWARD_PER_TASK_INFORMATION_H
...
class PerTaskInformation : public subscriber::Subscriber<PlanningTask> {
    /*
      ...
      associated entry yet. It receives a ClassicalTaskProxy instead of the
      ClassicalTask because ClassicalTask is an internal implementation detail
      as far as other classes are concerned. It should return a unique_ptr to
