#ifndef DOWNWARD_PLAN_MANAGER_H
#define DOWNWARD_PLAN_MANAGER_H
...
public:
    ...
    const std::string& get_plan_filename();
...
extern int
calculate_plan_cost(const Plan& plan, const ClassicalTaskProxy& task_proxy);
